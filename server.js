...
const run = async () => {
  ...
  // nota: en el ejercicio hay dos bootcamps que violan la restricción del máximo de clases
  // por ello, dejé un error de ejemplo, y cambié los datos dados para poder asignarlos
  // a los estudiantes en ejercicios posteriores
